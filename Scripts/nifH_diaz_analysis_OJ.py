...
for month in months_vec:
    diaz = xr.open_dataset('run19_33/MONTHS/3d.00000'+str(mon_list[month])+'.nc')
...
diazotroph_observations = pd.read_csv(r'nifH_Gene_Integral_mod.csv')
