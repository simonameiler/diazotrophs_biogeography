...
#%% Conversion factors for nifH abundance to cell numbers
...
conversion_nif_cell_low = [tri_l, UCYNA_l, UCYN_l, Ric_l]
conversion_nif_cell_high = [tri_h, UCYNA_h, UCYN_h, Ric_h]
